...
```sh
gh secret set SIGNING_P12_BASE64   --repo aang-dev-ag/tinycast < /tmp/signing.p12.base64
gh secret set SIGNING_P12_PASSWORD --repo aang-dev-ag/tinycast --body "$P12_PASSWORD"
